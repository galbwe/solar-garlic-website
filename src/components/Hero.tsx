        ...
        <>
            <section className="h-full flex flex-col justify-center items-center">
                <div className="max-w-full rounded p-10 md:bg-purple-dark/70 flex flex-col justify-center items-center gap-8 md:gap-3">
                    <h1 className="text-center text-8xl md:text-8xl lg:text-9xl text-yellow">{title}</h1>
                    {/* desktop nav links */}
            ...
            <Image fill className="invisible md:visible -z-50" src={lionsLair01} alt="Solar Garlic on stage at The Lion's Lair." />
            <Image fill className="visible md:invisible -z-50" src={lionsLair01Small} alt="Solar Garlic on stage at The Lion's Lair." />
        </>
    )
