...
export default function About() {
    return (
        <div className="w-full flex flex-row flex-wrap justify-center items-center gap-1">
            <section className="text-xl w-5/6 lg:w-4/5 2xl:w-2/5 flex flex-col gap-3 bg-purple-dark p-12 rounded border-2 border-purple-light">
                ...
                <p>
                    ...
                    They can frequently be found delivering their unique style of jam music at local Denver venues such as The Lion's Lair, The Roxy on Broadway, and Goosetown Tavern.
                </p>
                <p>
                    Solar Garlic consists of:
                </p>
                <ul className='gap-2'>
                    <li><span className='font-bold'>Davie Pyle</span> on guitar and vocals</li>
                    <li><span className='font-bold'>Sabrina Scherma</span> on guitar, keys, and vocals</li>     
                    <li><span className='font-bold'>Haley Brueckman</span> on drums </li>
                    <li><span className='font-bold'>Wes Galbraith</span> on bass and vocals.</li>
                </ul> 
                <p>
